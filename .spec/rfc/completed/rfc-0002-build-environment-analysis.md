...
**状态**: 历史分析 (Historical Analysis)  
**作者**: 开发团队  
**创建日期**: 2024-12-19  
**最后更新**: 2026-04-25  
**相关 RFC**: [RFC-0001](./rfc-0001-modernization-proposal.md), [RFC-0003](./rfc-0003-implementation-plan.md)

> **当前使用方式**：本文保留为早期技术栈与风险分析，不再代表当前构建事实。当前仓库以 `src\splayer.sln`、仓库根 `out\` 和 [RFC-0011](./rfc-0011-windows-repository-layout.md) 的路径契约为准；第三方库版本和升级状态以 [RFC-0012](./rfc-0012-thirdparty-library-upgrades.md) 与 [TASK_TRACKING](../../../TASK_TRACKING.md) 为准。

## 0. 现行事实来源

| 问题域 | 当前事实来源 |
|--------|--------------|
| 仓库布局、`$(SolutionDir)`、`out\` 输出根 | [RFC-0011](./rfc-0011-windows-repository-layout.md) |
| 第三方库升级和版本钉扎 | [RFC-0012](./rfc-0012-thirdparty-library-upgrades.md) |
| Rust / Cargo / MSBuild 接入 | [RFC-0013](./rfc-0013-rust-native-module-integration.md) |
| 当前任务状态 | [TASK_TRACKING](../../../TASK_TRACKING.md) |

下文仍有价值的是“早期为什么认为这些点有风险”；若与上述文档冲突，以上述现行事实来源为准。
