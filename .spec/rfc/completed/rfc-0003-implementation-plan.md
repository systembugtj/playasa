...
**状态**: 历史计划 (Historical Plan)  
**作者**: 开发团队  
**创建日期**: 2024-12-19  
**最后更新**: 2026-04-25  
**相关 RFC**: [RFC-0001](./rfc-0001-modernization-proposal.md), [RFC-0002](./rfc-0002-build-environment-analysis.md)

> **当前使用方式**：本文保留为早期实施计划，不再作为当前执行清单。当前工作以 [TASK_TRACKING](../../../TASK_TRACKING.md) 为主；已完成的工程契约和三方/Rust 迁移记录见 [RFC-0011](./rfc-0011-windows-repository-layout.md)、[RFC-0012](./rfc-0012-thirdparty-library-upgrades.md)、[RFC-0013](./rfc-0013-rust-native-module-integration.md)、[RFC-0014](./rfc-0014-rust-playlist-parser.md)、[RFC-0016](./rfc-0016-rust-mpc-playlist-parser.md)。

## 0. 当前执行入口

| 需要做的事 | 当前入口 |
|------------|----------|
| 看哪些任务已完成、哪些待办 | [TASK_TRACKING](../../../TASK_TRACKING.md) |
| 修改仓库布局或 MSBuild 路径 | [RFC-0011](./rfc-0011-windows-repository-layout.md) |
| 升级或审计第三方库 | [RFC-0012](./rfc-0012-thirdparty-library-upgrades.md)、[RFC-0019](../rfc-0019-thirdparty-crt-mfc-linkage-contract.md) |
| 继续 Rust 替换小模块 | [RFC-0013](./rfc-0013-rust-native-module-integration.md) |
| 继续 playlist parser 后续格式 | [RFC-0014](./rfc-0014-rust-playlist-parser.md)、[RFC-0016](./rfc-0016-rust-mpc-playlist-parser.md) |

下文保留为历史计划和对照材料；其中 checklist 未必反映当前仓库状态。
