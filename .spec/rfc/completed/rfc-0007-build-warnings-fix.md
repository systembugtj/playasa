...
> **当前使用方式**：本文保留为早期构建警告/路径修复记录，不再作为当前待办。输出目录与 MSBuild 路径的现行契约已收敛到 [RFC-0011](./rfc-0011-windows-repository-layout.md)；第三方库与全量构建验证记录见 [RFC-0012](./rfc-0012-thirdparty-library-upgrades.md) 和 [TASK_TRACKING](../../../TASK_TRACKING.md)。
...
**完成说明**: 早期修复已被后续 RFC-0011 输出目录契约和全量构建验证收敛；不再保留独立待办。
