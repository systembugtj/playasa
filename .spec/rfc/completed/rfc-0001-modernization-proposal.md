...
**状态**: 历史提案 (Historical Proposal)  
**作者**: 开发团队  
**创建日期**: 2024-12-19  
**最后更新**: 2026-04-25

> **当前使用方式**：本文保留为最早的现代化方向记录，不再作为执行计划。当前可执行入口请看 [TASK_TRACKING](../../../TASK_TRACKING.md)；仓库布局和 MSBuild 路径契约以 [RFC-0011](./rfc-0011-windows-repository-layout.md) 为准；第三方库升级以 [RFC-0012](./rfc-0012-thirdparty-library-upgrades.md) 为准；Rust 原生模块接入以 [RFC-0013](./rfc-0013-rust-native-module-integration.md)、[RFC-0014](./rfc-0014-rust-playlist-parser.md)、[RFC-0016](./rfc-0016-rust-mpc-playlist-parser.md) 为准。

## 0. 现行拆分

本文提出的是大方向，后来已经拆成更小、可验证的 RFC 和任务：

| 原始方向 | 当前落点 |
|----------|----------|
| 仓库目录、输出目录、MSBuild 路径 | [RFC-0011](./rfc-0011-windows-repository-layout.md) |
