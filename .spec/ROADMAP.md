...
| 0033 | DXVA 阶段 2：H.264 / VC-1 | 已完成 | [.spec/rfc/completed/rfc-0033-ffmpeg-dxva-phase2-h264-vc1.md](.spec/rfc/completed/rfc-0033-ffmpeg-dxva-phase2-h264-vc1.md) |
...
| 0046 | MpaDecFilter modern 音频迁移 | 已完成 | [.spec/rfc/completed/rfc-0046-mpadecfilter-modern-audio.md](.spec/rfc/completed/rfc-0046-mpadecfilter-modern-audio.md) |
| 0047 | FfmpegContext DXVA glue 退役 | **执行中** | [.spec/rfc/rfc-0047-ffmpegcontext-dxva-glue-retirement.md](.spec/rfc/rfc-0047-ffmpegcontext-dxva-glue-retirement.md) |
...
├── RFC-0046 (MpaDecFilter modern audio) ✓
├── RFC-0033 (DXVA H.264/VC-1 picture contract) ✓
├── RFC-0047 (FfmpegContext DXVA glue 退役；删树前置)
└── RFC-0035 (门禁全绿后删旧 ffmpeg 树)

RFC-0025 (已完成审计) ──► RFC-0030 ──► RFC-0033 ──► RFC-0047 ──► RFC-0035
```
...
| 优先级 | RFC | 原因 |
| --- | --- | --- |
| P0 | **0035** / **0047** | 旧树退役；0047 退役 `FfmpegContext` DXVA glue（阶段 1 已落地） |
...
| 0033 | `test-rfc0033-h264-dxva-selfcheck.ps1`；`src/BuildScript/audit-rfc0033-dxva-h264-vc1-refs.ps1` |
...
| 0047 | `test-rfc0047-dxva-decoder-no-avcodec.ps1`；接续 `test-rfc0033-h264-dxva-selfcheck.ps1` |
