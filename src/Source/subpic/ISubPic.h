...
interface __declspec(uuid("449E11F3-52D1-4a27-AA61-E2733AC92CC0")) ISubPic : public IUnknown
{
...
interface __declspec(uuid("CF7C3C23-6392-4a42-9E72-0736CFF793CB")) ISubPicAllocator : public IUnknown
{
...
interface __declspec(uuid("D62B9A1A-879A-42db-AB04-88AA8F243CFD")) ISubPicProvider : public IUnknown
{
	STDMETHOD (Lock) () PURE;
	STDMETHOD (Unlock) () PURE;
...
interface __declspec(uuid("C8334466-CD1E-4ad1-9D2D-8EE8519BD180")) ISubPicQueue : public IUnknown
{
...
interface __declspec(uuid("DE11E2FB-02D3-45e4-A174-6B7CE2783BDB")) ISubStream : public IPersist
{
