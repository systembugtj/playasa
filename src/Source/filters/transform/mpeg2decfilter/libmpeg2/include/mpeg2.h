...
typedef struct mpeg2_picture_s {
    ...
    /* mod for filter, r1323 */
    int64_t rtStart, rtStop;
    int32_t fDiscontinuity, fDelivered;
    /* end of mod */
} mpeg2_picture_t;
...
typedef struct mpeg2_info_s {
     ...
     mpeg2_gop_t * gop;
     mpeg2_picture_t * current_picture;
     mpeg2_picture_t * current_picture_2nd;
     mpeg2_fbuf_t * current_fbuf;
     mpeg2_picture_t * display_picture;
     mpeg2_picture_t * display_picture_2nd;
     mpeg2_fbuf_t * display_fbuf;
     mpeg2_fbuf_t * discard_fbuf;
     uint8_t * user_data;
...
/* mod for filter */
mpeg2_picture_t* mpeg2_get_pictures (mpeg2dec_t * mpeg2dec);
mpeg2_picture_t* mpeg2_get_picture (mpeg2dec_t * mpeg2dec);
/* end of mod */
