 ...
 */
#define  FMC_HAVE_MMX2 1
#define  FMC_HAVE_MMX 1
#define  FMC_HAVE_SSE 1
#define  FMC_HAVE_SSE2 1
#define  FMC_FUNCNAME fast_memcpy
...
#if FMC_HAVE_MMX && !FMC_HAVE_MMX2 && !HAVE_AMD3DNOW && !FMC_HAVE_SSE
...
#undef HAVE_K6_2PLUS
#if !FMC_HAVE_MMX2 && HAVE_AMD3DNOW
...
#define size_t int
#endif
static void * FMC_FUNCNAME(void * to, const void * from, size_t len)
{
	void *retval;
	size_t i;
	retval = to;
        ...
        if(len >= MIN_LEN)
	{
	  ...
	  len&=63;
        ...
        */
#if FMC_HAVE_SSE /* Only P3 (may be Cyrix3) */
