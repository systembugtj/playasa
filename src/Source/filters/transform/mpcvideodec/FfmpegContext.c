...
struct AVCodecContext* pAVCtx, struct AVFrame* pFrame, int* nNextCodecIndex, int* nFieldType, int* nSliceType, BYTE* pBuffer, UINT nSize)
{
    ...
    pPicParams->bMacroblockWidthMinus1			= 15;	// This is equal to ?5?for MPEG-1, MPEG-2, H.263, and MPEG-4
    pPicParams->bMacroblockHeightMinus1			= 15;	// This is equal to ?5?for MPEG-1, MPEG-2, H.261, H.263, and MPEG-4

    pPicParams->bBlockWidthMinus1				= 7;	// This is equal to ??for MPEG-1, MPEG-2, H.261, H.263, and MPEG-4
    pPicParams->bBlockHeightMinus1				= 7;	// This is equal to ??for MPEG-1, MPEG-2, H.261, H.263, and MPEG-4

    pPicParams->bBPPminus1						= 7;	// It is equal to ??for MPEG-1, MPEG-2, H.261, and H.263
    ...
    // pPicParams->bRcontrol					= 0;	// It shall be set to ??for all MPEG-1, and MPEG-2 bitstreams in order to conform with the rounding operator defined by those standards
