...
class __declspec(uuid("95C3F9F6-1E05-4C34-8122-504476EACB51")) CSSFSplitterFilter : public CBaseSplitterFilter
{
...
class __declspec(uuid("57F46A2A-6DC9-4A9F-B5FA-DFDD62B8BAFB")) CSSFSourceFilter : public CSSFSplitterFilter
{
public:
