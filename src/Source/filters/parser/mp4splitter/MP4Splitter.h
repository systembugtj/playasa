...
class __declspec(uuid("61F47056-E400-43d3-AF1E-AB7DFFD4C4AD")) CMP4SplitterFilter : public CBaseSplitterFilter
{
...
class __declspec(uuid("3CCC052E-BDEE-408a-BEA7-90914EF2964B")) CMP4SourceFilter : public CMP4SplitterFilter
{
public:
...
class __declspec(uuid("D3D9D58B-45B5-48AB-B199-B8C40560AEC7")) CMPEG4VideoSplitterFilter : public CBaseSplitterFilter
{
...
class __declspec(uuid("E2B98EEA-EE55-4E9B-A8C1-6E5288DF785A")) CMPEG4VideoSourceFilter : public CMPEG4VideoSplitterFilter
{
public:
