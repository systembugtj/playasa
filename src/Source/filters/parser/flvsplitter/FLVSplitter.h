...
class __declspec(uuid("47E792CF-0BBE-4F7A-859C-194B0768650A")) CFLVSplitterFilter : public CBaseSplitterFilter
{
	UINT32 m_DataOffset;
...
class __declspec(uuid("C9ECE7B3-1D8E-41F5-9F24-B255DF16C087")) CFLVSourceFilter : public CFLVSplitterFilter
{
public:
