...
class __declspec(uuid("C73DF7C1-21F2-44C7-A430-D35FB9BB298F")) CRoQSplitterFilter : public CBaseSplitterFilter
{
...
class __declspec(uuid("02B8E5C2-4E1F-45D3-9A8E-B8F1EDE6DE09")) CRoQSourceFilter : public CRoQSplitterFilter
{
public:
...
class __declspec(uuid("FBEFC5EC-ABA0-4E6C-ACA3-D05FDFEFB853")) CRoQVideoDecoder : public CTransformFilter
{
...
class __declspec(uuid("226FAF85-E358-4502-8C98-F4224BE76953")) CRoQAudioDecoder : public CTransformFilter
{
public:
