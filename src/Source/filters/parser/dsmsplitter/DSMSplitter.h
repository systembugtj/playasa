...
class __declspec(uuid("0912B4DD-A30A-4568-B590-7179EBB420EC")) CDSMSplitterFilter : public CBaseSplitterFilter
{
protected:
...
class __declspec(uuid("803E8280-F3CE-4201-982C-8CD8FB512004")) CDSMSourceFilter : public CDSMSplitterFilter
{
public:
