...
void CPlayerToolBar::SetMute(bool fMute)
{
  ...
  AfxGetCurrentSettings().fMute = fMute;
...
bool CPlayerToolBar::IsMuted()
{
  ...
  return AfxGetCurrentSettings().fMute;
}
...
{
  AfxGetCurrentSettings().fMute = !IsMuted();
  ArrangeControls();
  return FALSE;
}
    ...
    case TIMER_ADFETCHING:
      {
        ...
        std::wstring ad_uri = Strings::Format(L"https://www.shooter.cn/api/v2/prom.php?lang=%d", AfxGetCurrentSettings().iLanguage);
...
void CPlayerToolBar::DefaultButtonManage()
{
  ...
  CONFIGBUTTON(STOP,BTN_STOP.BMP,ALIGN_TOPLEFT, CRect(-50,-50,3,3),0,ID_PLAY_MANUAL_STOP,FALSE,710,ALIGN_RIGHT,PAUSE,DEFAULT_MARGIN_TOBUTTON)
  CONFIGADDALIGN(STOP,ALIGN_RIGHT, PLAY , DEFAULT_MARGIN_TOBUTTON)

  CONFIGBUTTON(STEP,BTN_STEP.BMP,ALIGN_TOPLEFT,CRect(-50,-50,3,3), 0,ID_PLAY_FRAMESTEP,FALSE,710,ALIGN_LEFT,PAUSE,DEFAULT_MARGIN_TOBUTTON)
  CONFIGADDALIGN(STEP,ALIGN_LEFT,PLAY, DEFAULT_MARGIN_TOBUTTON)

  CONFIGBUTTON(FASTFORWORD,FAST_FORWORD.BMP,ALIGN_TOPLEFT,CRect(-50,-50,3,3),0,ID_PLAY_FWD,FALSE,580,ALIGN_LEFT,PAUSE,DEFAULT_MARGIN_TOBUTTON)
  ...
  CONFIGBUTTON(FASTBACKWORD,FAST_BACKWORD.BMP,ALIGN_TOPLEFT,CRect(-50,-50,3,3),0,ID_PLAY_BWD,FALSE,580,ALIGN_RIGHT,PAUSE,DEFAULT_MARGIN_TOBUTTON)
  ...
  CONFIGBUTTON(PREV,BTN_PREV.BMP,ALIGN_TOPLEFT,CRect(-50,-50,3,3),0,ID_NAVIGATE_SKIPBACK,FALSE,630,ALIGN_RIGHT,FASTBACKWORD,DEFAULT_MARGIN_TOBUTTON)
  ...
  CONFIGBUTTON(NEXT,BTN_NEXT.BMP,ALIGN_TOPLEFT,CRect(-50,-50,3,3),0,ID_NAVIGATE_SKIPFORWARD,FALSE,630,ALIGN_LEFT,FASTFORWORD,DEFAULT_MARGIN_TOBUTTON)
