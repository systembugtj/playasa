...
public:
  ...
  bool IsInteractiveVideo() {return(AfxGetCurrentSettings().fIntRealMedia && m_fRealMediaGraph || m_fShockwaveGraph);}
...
//   //  Snapshot
  ...
  bool IsFrameLessWindow() {return(m_fFullScreen || AfxGetCurrentSettings().fHideCaptionMenu);}
  bool IsCaptionMenuHidden() {return(!m_fFullScreen && AfxGetCurrentSettings().fHideCaptionMenu);}
  ITaskbarList3* pTBL  ;
