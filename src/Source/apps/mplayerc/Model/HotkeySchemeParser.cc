...
#define ADDCMD(cmd) m_list.push_back(HotkeyCmd##cmd)
  ...
  ADDCMD((ID_SCREENSNAPSHOT, 'A', FVIRTKEY|FCONTROL|FALT|FNOINVERT, IDS_HOTKEY_SCREENSNAPSHOT));
  ADDCMD((ID_SCREENSNAPSHOTTOCLIPBOARD, 'C', FVIRTKEY|FCONTROL|FNOINVERT, IDS_HOTKEY_SCREENSNAPSHOT));
...
unsigned int HotkeySchemeParser::GetCmdCodeByCmdName(std::wstring cmdname)
{
  ...
  CHKCMDNAME(ID_SCREENSNAPSHOT);
  CHKCMDNAME(ID_SCREENSNAPSHOTTOCLIPBOARD);
...
std::wstring HotkeySchemeParser::GetCmdNameByCmdCode(unsigned int cmdcode)
{
  switch (cmdcode)
  {
    ...
    CHKCMDCODE(ID_SCREENSNAPSHOT);
    CHKCMDCODE(ID_SCREENSNAPSHOTTOCLIPBOARD);
