...
BOOL OptionBasicPage::OnInitDialog(CWindow hwnd, LPARAM lParam)
{
...
int OptionBasicPage::OnApply()
{
	...
	AfxGetCurrentSettings().hAccel = GetAcceleratorTable();
	CMainFrame *pMainFrame = (CMainFrame *)AfxGetMainWnd();
	if (pMainFrame)
	{
		pMainFrame->m_hAccelTable = AfxGetCurrentSettings().hAccel;
	}
