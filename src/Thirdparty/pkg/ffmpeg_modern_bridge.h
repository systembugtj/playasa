...
enum {
    ...
    PLAYASA_FFMPEG_MODERN_CODEC_WMAV1 = 22,
    PLAYASA_FFMPEG_MODERN_CODEC_WMAV2 = 23,
    PLAYASA_FFMPEG_MODERN_CODEC_AMR_NB = 24,
    PLAYASA_FFMPEG_MODERN_CODEC_AMR_WB = 25,
    PLAYASA_FFMPEG_MODERN_CODEC_NELLYMOSER = 26,
    PLAYASA_FFMPEG_MODERN_CODEC_QDM2 = 27,
    PLAYASA_FFMPEG_MODERN_CODEC_EAC3 = 28,
    PLAYASA_FFMPEG_MODERN_CODEC_TRUEHD = 29,
    PLAYASA_FFMPEG_MODERN_CODEC_MLP = 30,
    PLAYASA_FFMPEG_MODERN_CODEC_FLAC = 31,
    PLAYASA_FFMPEG_MODERN_CODEC_PCM_MULAW = 32,
    PLAYASA_FFMPEG_MODERN_CODEC_ADPCM_IMA_QT = 33
};
